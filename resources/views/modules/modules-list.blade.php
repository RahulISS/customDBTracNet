							...
							<table id="tablefilter" class="table table-striped table-bordered" style="width:100%">
								...
								<tbody>
									...
									<tr>
										...
										<td>
                                            <a href="{{route('editmodule',$row->id)}}" class="btn btn-info"><i class="bx bx-edit-alt"></i></a>
                                            <a href="{{route('delete.module',$row->id)}}" class="btn btn-danger"><i class="bx bx-trash-alt"></i></a>
                                        </td>
									</tr>
                                    @endforeach
